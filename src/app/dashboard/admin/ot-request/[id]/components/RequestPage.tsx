...
const RequestsPage = ({ users }: { users: User[] }) => {
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold mb-4">Overtime Pending Requests</h1>
        ...
        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
          <thead className="bg-gray-200 border-b border-gray-300">
            <tr>
              ...
              <th className="py-3 px-6 text-left text-gray-600">Hours</th>
              <th className="py-3 px-6 text-left text-gray-600">Type</th>
            ...
            {users.flatMap((user) =>
              user.overtimeRequests.map((request) => (
                <tr key={request.id} className="border-b border-gray-300">
                  ...
                  <td className="py-3 px-6 text-gray-800">{request.hours}</td>
